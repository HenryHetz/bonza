...
export default class PreloadScene extends Phaser.Scene {
  ...
  preloadAssets() {
    ...
    this.load.image('risk_tuner_panel_big', 'assets/sprites/elements/risk_tuner_panel_big.png')
    this.load.image('risk_tuner_panel_arraw', 'assets/sprites/elements/risk_tuner_panel_arraw.png')
